...
public class g14 {
	 ...
	 * Verificar site.
	 */
	static private void verificarSite() {
	 ...
	 * @throws EmailException the email exception
	 */
	static private void login() throws EmailException {
		try {
	 ...
	 * @throws EmailException the email exception
	 */
	private static void verWebpages() throws EmailException {
		try {
	 ...
	 * @throws EmailException the email exception
	 */
	static void contactUs() throws EmailException {
		try {
	 ...
	 * @throws EmailException the email exception
	 */
	static void joinUs() throws EmailException {
		try {
	 ...
	 * @throws EmailException the email exception
	 */
	private static void enviarEmail(String CorpoDeTexto) throws EmailException {
